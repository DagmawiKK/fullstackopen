  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 mb-4">
      <div>
        ...
        <input  required onChange={handleNewName} value={newName} type="text" name="name" id="name" className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      <div>
        <label htmlFor="number" className="block text-sm font-medium text-gray-700">Number:</label>
        <input  required onChange={handleNewNumber} value={newNumber} type="text" name="number" id="number" className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      <div>
...
const Notification = ({notification}) => {
  ...
  const notificationStyle = notification[0] === "m" ? "bg-green-500 text-white p-4 rounded-md" : "bg-red-500 text-white p-4 rounded-md";
